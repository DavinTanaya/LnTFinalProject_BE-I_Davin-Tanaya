...
<body>
    ...
    <div class="container center-box">
        <div class="login-box">
            <h2 class="mb-4 text-center">PT Chipi Chapa Login</h2>
            <form method="POST" action="{{route('login')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="name" name="email">
                </div>
                <div class="form-group">
